...
class CvPdfService {
  ...
  pw.EdgeInsets _getMargins(TemplateType type) {
    switch (type) {
      case TemplateType.minimalist:
        return const pw.EdgeInsets.all(60); // More whitespace
    ...
    return pw.Column(
      ...
      children: [
        ...
        pw.Text(
          ...
          style: pw.TextStyle(
            font: boldFont,
            fontSize: isMinimalist ? 32 : 28,
            color: isMinimalist ? PdfColors.black : accentColor,
            letterSpacing: isMinimalist ? -1.0 : -0.5,
          ),
        ),
        pw.SizedBox(height: isMinimalist ? 12 : 8),
        ...
        pw.Wrap(
          ...
          children: [
            if (info.email != null)
              _buildContactItem(
                  'Email', info.email!, regularFont, accentColor, isMinimalist),
            if (info.phone != null)
              _buildContactItem(
                  'Phone', info.phone!, regularFont, accentColor, isMinimalist),
            if (info.address != null)
              _buildContactItem('Address', info.address!, regularFont,
                  accentColor, isMinimalist),
          ],
        ),

        // Divider
        pw.SizedBox(height: isMinimalist ? 16 : 12),
        pw.Container(
      ...
      children: [
        pw.Text(
          ...
          style: pw.TextStyle(
            font: font,
            fontSize: 9,
            color: isMinimalist ? PdfColors.grey700 : accentColor,
  ...
  pw.Widget _buildSection({
    ...
    final isMinimalist = templateType == TemplateType.minimalist;
    final isClassic = templateType == TemplateType.classic;
      ...
      children: [
        pw.Text(
          ...
          style: pw.TextStyle(
            ...
            color: isMinimalist ? PdfColors.grey800 : accentColor,
