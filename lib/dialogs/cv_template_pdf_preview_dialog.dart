...
/// Full-screen PDF preview dialog for CV templates with integrated style selection
///
...
class _CvTemplatePdfPreviewDialogState
          ...
          children: [
            ...
            Expanded(
              child: PdfPreview(
                ...
                allowPrinting: true,
                pdfFileName:
                    '${widget.cvTemplate.name.replaceAll(' ', '_')}_${_selectedStyle.type.label}.pdf',
              ),
            ),
          ],
        ),
  ...
  Future<Uint8List> _generatePdf() async {
    ...
    final tempFile = File(path.join(tempDir.path, 'temp_preview.pdf'));
